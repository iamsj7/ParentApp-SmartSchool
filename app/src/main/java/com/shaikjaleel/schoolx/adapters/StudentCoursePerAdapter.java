...
import com.shaikjaleel.schoolx.students.StudentCoursePerformance;
...
public class StudentCoursePerAdapter extends RecyclerView.Adapter<StudentCoursePerAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        PieChart pieChart;
        TextView quiz_name,quiz_no,correct_count,wrong_count,noanswer_count,total_question;
    ...
    public void onBindViewHolder(StudentCoursePerAdapter.MyViewHolder holder, final int position) {
        ...
        holder.total_question.setText("Total Question: "+total_questionList.get(position));
