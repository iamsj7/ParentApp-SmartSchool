...
import com.shaikjaleel.schoolx.students.CoursePayment;
import com.shaikjaleel.schoolx.students.StudentCourseDetail;
import com.shaikjaleel.schoolx.students.StudentStartLessonActivity;
...
public class StudentOnlineCourseAdapter extends RecyclerView.Adapter<StudentOnlineCourseAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
      ...
      //  holder.classsection.setText(classsectionList.get(position));
        holder.lessoncount.setText(lessoncountList.get(position));
        ...
        try {
            ...
            for(int i = 0; i < dataArray.length(); i++) {
                ...
                String str=sectionList.toString().replace('[', '(');
        ...
        if(free_courselist.get(position).equals("1")){
            holder.coursediscount.setText("FREE");
