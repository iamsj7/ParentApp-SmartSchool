...
import com.shaikjaleel.schoolx.model.Album1;
import com.shaikjaleel.schoolx.students.CbseExaminationActivity;
import com.shaikjaleel.schoolx.students.StudentAttendance;
import com.shaikjaleel.schoolx.students.StudentBehaviourReport;
import com.shaikjaleel.schoolx.students.StudentClassTimetable;
import com.shaikjaleel.schoolx.students.StudentDocuments;
import com.shaikjaleel.schoolx.students.StudentExaminationList;
import com.shaikjaleel.schoolx.students.StudentSyllabusStatus;
import com.shaikjaleel.schoolx.students.StudentTimeline;
...
public class AcademicModuleAdapter extends RecyclerView.Adapter<AcademicModuleAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        if(position==0) {
            ...
            }else if(album.getName().equals("cbse")){
