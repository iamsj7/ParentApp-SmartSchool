...
import com.shaikjaleel.schoolx.students.StudentAppyLeave;
import com.shaikjaleel.schoolx.students.StudentEditLeave;
...
public class StudentApplyLeaveAdapter extends RecyclerView.Adapter<StudentApplyLeaveAdapter.MyViewHolder> {
    ...
    public StudentApplyLeaveAdapter(StudentAppyLeave studentapplyleave, ArrayList<String> nameList, ArrayList<String> fromList,
                                    ...
                                    ArrayList<String> reasonlist,ArrayList<String> sfromlist,ArrayList<String> stolist,ArrayList<String> sapplylist,ArrayList<String> approve_datestatuslist) {
        ...
        this.approve_datestatuslist = approve_datestatuslist;

    }
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView fromdate,todate,Pending,Approve,Applied_date,reason;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
       ...
       if(statuslist.get(position).equals("0")){
           ...
           holder.Approve.setText(context.getApplicationContext().getString(R.string.pending));
           ...
           holder.Approve.setText(context.getApplicationContext().getString(R.string.disapproved));
           holder.delete.setVisibility(View.GONE);
           holder.edit.setVisibility(View.GONE);
           holder.Approve.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.red_border));
       }else if (statuslist.get(position).equals("1")) {
           if(approve_datestatuslist.get(position).equals("")){
               holder.Approve.setText(context.getApplicationContext().getString(R.string.approved));
           }else {
               holder.Approve.setText(context.getApplicationContext().getString(R.string.approved) + " (" + approve_datestatuslist.get(position) + ")");
           }
           holder.delete.setVisibility(View.GONE);
           holder.edit.setVisibility(View.GONE);
