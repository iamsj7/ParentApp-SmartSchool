...
import com.shaikjaleel.schoolx.students.StudentOnlineExamQuestionsNew;
import com.shaikjaleel.schoolx.students.StudentOnlineExamResult;
...
public class StudentOnlineExamListAdapter extends RecyclerView.Adapter<StudentOnlineExamListAdapter.MyViewHolder> {
    ...
    public StudentOnlineExamListAdapter(FragmentActivity studentonlineexam,RecyclerView recyclerView,ArrayList<String> examList, ArrayList<String> exam_fromList,
                                        ...
                                        ArrayList<String> is_marks_displaylist,ArrayList<String> is_neg_markinglist,ArrayList<String> passing_percentagelist,ArrayList<String> total_questionlist
                                        ,ArrayList<String> total_descriptivelist,ArrayList<String> answer_word_countlist,ArrayList<String> descriptionlist) {
        ...
        this.answer_word_countlist = answer_word_countlist;
        this.descriptionlist = descriptionlist;
    }
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView examname,datefrom,dateto,totalattempts,attempted,duration,quiz,status,passing_per,descriptive_ques,total_ques,description,answerwordcount;
        ...
        public MyViewHolder(View view) {
            ...
            description = view.findViewById(R.id.adapter_student_description);
            answerwordcount = view.findViewById(R.id.total_answerwordcount);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        String plain = Html.fromHtml(descriptionlist.get(position)).toString();
        holder.description.setText(plain);
       // holder.answerwordcount.setText(answer_word_countlist.get(position));
        if(answer_word_countlist.get(position).equals("-1")){
            holder.answerwordcount.setText(R.string.noLimit);
        }else{
            holder.answerwordcount.setText(answer_word_countlist.get(position));
        }
        ...
        if(is_quizlist.get(position).equals("1")) {
            holder.quiz.setText(R.string.yes);
            ...
            holder.quiz.setText(R.string.no);
