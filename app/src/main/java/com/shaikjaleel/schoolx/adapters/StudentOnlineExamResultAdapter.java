...
public class StudentOnlineExamResultAdapter extends RecyclerView.Adapter<StudentOnlineExamResultAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView subject,marks,neg_marks,sno,question;
        ...
        WebView optionA,optionB,optionC,optionD,optionE,descriptive_answer,teacher_remark;
        WebView moptionA,moptionB,moptionC,moptionD,moptionE;
        LinearLayout multiplechoice_layout,truefalse_layout,singlechoice_layout,descriptive_layout,remark_layout,nameHeader;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.question.setBackgroundColor(Color.parseColor(Utility.getSharedPreferences(context.getApplicationContext(), Constants.secondaryColour)));

        holder.subject.setText(subject_namelist.get(position));
        holder.sno.setText("Q."+String.valueOf(position+1));

        String plain = Html.fromHtml(questionlist.get(position)).toString();
        holder.question.setText(plain);
