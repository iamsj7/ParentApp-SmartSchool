...
public class StudentGmeetLiveClassesAdapter extends RecyclerView.Adapter<StudentGmeetLiveClassesAdapter.MyViewHolder> {
    ...
    public StudentGmeetLiveClassesAdapter(FragmentActivity studentonlineexam, ArrayList<String> titleList, ArrayList<String> dateList,
                                          ArrayList<String> classList, ArrayList<String> idList, ArrayList<String> join_url,
                                          ArrayList<String> statuslist, ArrayList<String> staff_namelist, ArrayList<String> descriptionlist, ArrayList<String> durationlist, ArrayList<String> staff_rolelist) {
        ...
        this.staff_rolelist = staff_rolelist;
    }

    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView titlename, date, classes, class_host,status,description,classduration;
        LinearLayout joinclass,complete_status;
        ...
        public MyViewHolder(View view) {
            ...
            complete_status = view.findViewById(R.id.complete_status_layout);
            status = view.findViewById(R.id.status);
            description = view.findViewById(R.id.gmeet_description);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.classduration.setText(durationlist.get(position));
        ...
        if(superadmin_restriction.equals("enabled")){
            ...
            if(staff_rolelist.get(position).equals("Super Admin")){
                holder.class_host.setText("");
            }else{
                holder.class_host.setText(staff_namelist.get(position));
            }
        }
        if (statuslist.get(position).equals("0")) {
           ...
           // holder.complete_status.setVisibility(View.GONE);
            holder.joinclass.setVisibility(View.GONE);
        } else {
