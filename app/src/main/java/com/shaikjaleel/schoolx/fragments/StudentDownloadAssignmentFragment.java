...
import com.shaikjaleel.schoolx.adapters.StudentDownloadsAdapter;
...
public class StudentDownloadAssignmentFragment extends Fragment {
    ...
    ArrayList<String> uploadcontentsArray = new ArrayList<String>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new StudentDownloadsAdapter(getActivity(), idList, nameList, sharedateList, sharebyList,valid_uptoList,descriptionList,uploaddateList,uploadcontentsArray,checkdate,created_bylist);
                    ...
                    try {
                        ...
                        created_bylist.clear();
                            ...
                            for(int i = 0; i < object.length(); i++) {
                                ...
                                uploadcontentsArray.add(object.getJSONObject(i).getJSONArray("upload_contents").toString());
