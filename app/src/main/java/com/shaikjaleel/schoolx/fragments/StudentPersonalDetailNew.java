package com.shaikjaleel.schoolx.fragments;
...
import com.shaikjaleel.schoolx.adapters.StudentProfileCustomAdapter;
import com.shaikjaleel.schoolx.utils.Constants;
import com.shaikjaleel.schoolx.utils.DatabaseHelperCustomNew;
...
public class StudentPersonalDetailNew extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    TextView rollno, bloodgroup, mobileno, religion, caste, admDate, dob, category, email, currentAdd, permanentAdd, height, weight,gender,note;
    LinearLayout blood_layout, mobile_layout, religion_layout, Caste_layout, admDate_layout, dob_layout,gender_layout,note_layout,
            category_layout, email_layout, currentAdd_layout, permanentAdd_layout, height_layout, weight_layout, myLinearLayout1, myLinearLayout2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gender_layout = mainView.findViewById(R.id.gender_layout);
        gender = mainView.findViewById(R.id.gender);

        note_layout = mainView.findViewById(R.id.note_layout);
        note = mainView.findViewById(R.id.note);
            ...
            public void onResponse(String result) {
                ...
                if (result != null) {
                    try {
                        ...
                        gender.setText(dataArray.getString("gender"));
                        note.setText(dataArray.getString("note"));
