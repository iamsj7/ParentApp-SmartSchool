...
public class StudentOnlineCourseQuiz extends AppCompatActivity {
  ...
  //  JSONArray answerlist = new JSONArray();
    ...
    LinearLayout question_layout,nodata_layout,multiplechoice_layout,headerlayout;
                ...
                if (result != null) {
                    ...
                    try {
                       ...
                       // name.setText(dataObject.getString("exam"));
                        ...
                        final TextView question_count = (TextView) dialog.findViewById(R.id.question_count);
                        final TextView startBtn = (TextView) dialog.findViewById(R.id.startBtn);
                        title.setText(quiz_name);
                        question_count.setText(String.valueOf(dataArray.length()));
