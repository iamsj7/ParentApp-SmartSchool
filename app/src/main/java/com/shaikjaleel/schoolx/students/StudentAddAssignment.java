...
public class StudentAddAssignment extends AppCompatActivity {
    ...
    private void getScannerDataFromApi (String bodyParams) {
        ...
        StringRequest stringRequest = new StringRequest(com.android.volley.Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(StudentAddAssignment.this, R.string.apiErrorMsg, Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(StudentAddAssignment.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            Bitmap selectedImageString = BitmapFactory.decodeFile(filePath);
