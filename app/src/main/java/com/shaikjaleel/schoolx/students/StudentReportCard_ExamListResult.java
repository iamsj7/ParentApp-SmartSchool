...
import com.shaikjaleel.schoolx.adapters.StudentConsolidateDetailsAdapter;
...
import com.shaikjaleel.schoolx.adapters.StudentExamResultAdapter;
import com.shaikjaleel.schoolx.adapters.StudentExamResultGpaAdapter;
...
public class StudentReportCard_ExamListResult extends BaseActivity {
    ...
    String passedArg;
    TextView  reportCard_examResult,rank,rankgpa;
    TextView consolidate_layout,studentReportCard_credit,studentReportCard_qualitypoints;
    LinearLayout basic_layout,average_layout,gpa_layout,gpa_bottom_layout,basic_bottom_layout;
  CardView card_view_outer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTV.setText(getApplicationContext().getString(R.string.examresult));
        ...
        rankgpa = findViewById(R.id.rankgpa);
        average_layout = findViewById(R.id.average_layout);
        ...
        basic_bottom_layout.setBackgroundColor(Color.parseColor(Utility.getSharedPreferences(getApplicationContext(), Constants.secondaryColour)));
        gpa_bottom_layout.setBackgroundColor(Color.parseColor(Utility.getSharedPreferences(getApplicationContext(), Constants.secondaryColour)));
                ...
                if (result != null) {
                    ...
                    try {
                        ...
                        JSONObject exam = object.getJSONObject("exam");
                            ...
                            rank.setText(exam.getString("rank"));
                            ...
                            if(exam.getString("exam_type").equals("gpa")){
                                ...
                                rankgpa.setText(exam.getString("rank"));
                                Float value = Float.parseFloat(exam.getString("exam_quality_points"))/Float.parseFloat(exam.getString("exam_credit_hour"));

                                studentReportCard_qualitypoints.setText(exam.getString("exam_quality_points")+"/"+exam.getString("exam_credit_hour")+"="+new DecimalFormat("##.##").format(value)+" ["+exam.getString("exam_grade")+"]");

                                JSONArray dataArray = exam.getJSONArray("subject_result");
                                for(int i=0; i<dataArray.length(); i++) {
                                    examSubjectList.add(dataArray.getJSONObject(i).getString("name")+" ("+dataArray.getJSONObject(i).getString("code")+")");
                                ...
                                percentageTV.setText(new DecimalFormat("##.00").format(Float.parseFloat(exam.getString("percentage"))));
                              ...
                              //  percentageTV.setText(exam.getString("exam_credit_hour"));
                            ...
                            }else if(exam.getString("exam_type").equals("average_passing")){
                                reportCard_examResult.setVisibility(View.GONE);
                                basic_layout.setVisibility(View.GONE);
                                ...
                                for(int i=0; i<dataArray.length(); i++) {
                                    examSubjectList.add(dataArray.getJSONObject(i).getString("name")+" ("+dataArray.getJSONObject(i).getString("code")+")");
                                    examPassingMarksList.add(dataArray.getJSONObject(i).getString("max_marks"));
                                    examget_marksList.add(dataArray.getJSONObject(i).getString("get_marks"));
                                    exam_gradeList.add(dataArray.getJSONObject(i).getString("note"));

                                    if(dataArray.getJSONObject(i).getString("attendence").equals("absent")) {
                                        examObtainedMarksList.add(getApplicationContext().getString(R.string.absent));
                                    } else {
                                        examObtainedMarksList.add(dataArray.getJSONObject(i).getString("get_marks"));
                                    }
                                    examResultList.add("");
                                }
                    ...
                    try {
                        ...
                        if (success.equals("200")) {
                            ...
                            for(int i=0; i<examarray.length(); i++) {
                                ...
                                percentageList.add(examarray.getJSONObject(i).getString("percentage")+" ("+examarray.getJSONObject(i).getString("weight")+"%)");
                            ...
                            consolidate_marks.setText(consolidate_result.getString("percentage")+"["+consolidate_result.getString("grade")+"]");
