...
public class StudentEditTimeLine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateET.setText(Utility.parseDate("yyyy-MM-dd", defaultDateFormat,date));
        ...
        buttonSelectImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ((ContextCompat.checkSelfPermission(getApplicationContext(),
                    ...
                    if ((ActivityCompat.shouldShowRequestPermissionRationale(StudentEditTimeLine.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) &&
                            (ActivityCompat.shouldShowRequestPermissionRationale(StudentEditTimeLine.this, Manifest.permission.READ_EXTERNAL_STORAGE))) {
                    } else {
                        ActivityCompat.requestPermissions(StudentEditTimeLine.this, new String[]{
