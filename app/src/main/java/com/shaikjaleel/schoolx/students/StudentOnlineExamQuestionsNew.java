...
import com.shaikjaleel.schoolx.adapters.StudentQuestionsListAdapter;
...
public class StudentOnlineExamQuestionsNew extends AppCompatActivity {
    ...
    TextView questions;
    WebView option_a_value,option_b_value,option_c_value,option_d_value,option_e_value;
   ...
   String question_typeList;
    ...
    TextView answer_limit,textView;
    LinearLayout question_layout,headerlayout,nodata_layout,descriptive_layout,multiplechoice_layout,singlechoice_layout,truefalse_layout;
    String[] mimeTypes =
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answer_limit = findViewById(R.id.answer_limit);
        ...
        questions.setBackgroundColor(Color.parseColor(Utility.getSharedPreferences(getApplicationContext(), Constants.secondaryColour)));
        ...
        moption_a_value.getSettings().setDefaultFontSize((int)getResources().getDimension(R.dimen.largeheading));
        ...
        option_a_value.getSettings().setTextZoom(100);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(dataArray.length() != 0) {
                    ...
                    if(hold==1){
                        previous.setEnabled(false);
                        next.setBackground(ContextCompat.getDrawable(getApplicationContext(), R.drawable.examgreen_right_tabs));
                        previous.setBackground(ContextCompat.getDrawable(getApplicationContext(), R.drawable.grey_left_tabs));
                        next.setEnabled(true);
                    }else{
                        previous.setBackground(ContextCompat.getDrawable(getApplicationContext(), R.drawable.examgreen_left_tabs));
                        previous.setEnabled(true);
                    }
                    if(dataArray.length()<=(hold)){
                        next.setEnabled(false);
                        next.setBackground(ContextCompat.getDrawable(getApplicationContext(), R.drawable.grey_right_tabs));
                    }else{
                        next.setEnabled(true);
                        next.setBackground(ContextCompat.getDrawable(getApplicationContext(), R.drawable.examgreen_right_tabs));
                    }
                    ...
                    try {
                        String plain = Html.fromHtml(dataArray.getJSONObject(hold-1).getString("question")).toString();
                        questions.setText(plain);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(dataArray.length() != 0) {
                    ...
                    try {
                        String plain = Html.fromHtml(dataArray.getJSONObject(position).getString("question")).toString();
                        questions.setText(plain);
                ...
                if (result != null) {
                    ...
                    try {
                        ...
                        if(dataArray.length()>1) {
                            ...
                            sno.setText("1");
                            String plain = Html.fromHtml(dataArray.getJSONObject(0).getString("question")).toString();
                            questions.setText(plain);
                            ...
                            if(dataObject.getString("answer_word_count").equals("-1")){
                                answer_limit.setText("No Limit");
                            }else{
                                answer_limit.setText("Word Limit: "+dataObject.getString("answer_word_count"));
                                descriptive.addTextChangedListener(new TextWatcher() {
                                    ...
                                    public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                                        ...
                                        try {
                                            if (count == 0 && wordsLength >=Integer.parseInt(dataObject.getString("answer_word_count"))) {
                                                setCharLimit(descriptive, descriptive.getText().length());

                                                //descriptive.setFocusable(false);
                                            } else {
                                                removeFilter(descriptive);
                                                // descriptive.setFocusableInTouchMode(true);
                                            }
                                        } catch (JSONException e) {
                                            e.printStackTrace();
                                        }
                            ...
                            //dataObject.getString("answer_word_count");

                           // descriptive.setFilters(new InputFilter[] {new InputFilter.LengthFilter(Integer.parseInt(dataObject.getString("answer_word_count")))});
