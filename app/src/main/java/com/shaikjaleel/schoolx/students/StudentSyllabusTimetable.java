...
import com.shaikjaleel.schoolx.adapters.StudentSyllabusTimetableAdapter;
...
public class StudentSyllabusTimetable extends BaseActivity {
    ...
    LinearLayout mondayNoData,tuesdayNoData,wednesdayNoData,thursdayNoData,fridayNoData,saturdayNoData,sundayNoData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mondayNoData = findViewById(R.id.mondayNoData);
        tuesdayNoData = findViewById(R.id.tuesdayNoData);
        wednesdayNoData = findViewById(R.id.wednesdayNoData);
        thursdayNoData = findViewById(R.id.thursdayNoData);
        fridayNoData = findViewById(R.id.fridayNoData);
        saturdayNoData = findViewById(R.id.saturdayNoData);
        sundayNoData = findViewById(R.id.sundayNoData);
       ...
       // DateFormat df = new SimpleDateFormat("MM/dd/yyyy");
        ...
        mstartdate = Utility.parseDate("dd/MM/yyyy", "yyyy-MM-dd",startStringDate);
        String endStringDate = enddate_slider.getText().toString();
        menddate =Utility.parseDate("dd/MM/yyyy", "yyyy-MM-dd",endStringDate);
    ...
    protected void getpreviousweek() {
        ...
        String startStringDate = startdate_slider.getText().toString();
        pstartdate = Utility.parseDate("dd/MM/yyyy", "yyyy-MM-dd",startStringDate);
        String endStringDate = enddate_slider.getText().toString();
        penddate =Utility.parseDate("dd/MM/yyyy", "yyyy-MM-dd",endStringDate);
    ...
    protected void getnextweek() {
        ...
        String startStringDate = startdate_slider.getText().toString();
        nstartdate = Utility.parseDate("dd/MM/yyyy", "yyyy-MM-dd",startStringDate);
        String endStringDate = enddate_slider.getText().toString();
        nenddate =Utility.parseDate("dd/MM/yyyy", "yyyy-MM-dd",endStringDate);
                    ...
                    try {
                        ...
                        sundaytimeto.clear();
                            ...
                            if (thursdayArray.length() > 0) {
                                ...
                                thursdayNoData.setVisibility(View.VISIBLE);
                                thursdayList.setVisibility(View.GONE);
                            }

                            if (fridayArray.length() > 0) {
                                fridayNoData.setVisibility(View.GONE);
                                ...
                                fridayNoData.setVisibility(View.VISIBLE);
                            ...
                            if (sundayArray.length() > 0) {
                                ...
                                sundayList.setVisibility(View.VISIBLE);
                                ...
                                sundayNoData.setVisibility(View.VISIBLE);
                                sundayList.setVisibility(View.GONE);
                            }
