        ...
        buttonSelectImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ((ContextCompat.checkSelfPermission(getApplicationContext(),
                    ...
                    if ((ActivityCompat.shouldShowRequestPermissionRationale(StudentAddLeave.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) &&
                            (ActivityCompat.shouldShowRequestPermissionRationale(StudentAddLeave.this, Manifest.permission.READ_EXTERNAL_STORAGE))) {
                    } else {
                        ActivityCompat.requestPermissions(StudentAddLeave.this, new String[]{
