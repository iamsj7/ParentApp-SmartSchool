...
import com.shaikjaleel.schoolx.adapters.CourseCurriculumAdapterNew;
import com.shaikjaleel.schoolx.adapters.CourseReviewAdapterNew;
import com.shaikjaleel.schoolx.model.LessonModel;
import com.shaikjaleel.schoolx.model.SectionModel;
...
public class StudentCourseDetail  extends BaseActivity {
    ...
    TextView courseDescription,totalrating;
    ...
    String CourseId,teacherlist,CourseTitle,Courseprice,Coursediscount,Coursepaidlist,Courseprogress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(CourseRating.equals("0")){
          ...
          totalrating.setText(" ("+totalCourseRating+" Rating)");
                ...
                submitBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                       ...
                       if (review.getText().toString().isEmpty()) {
                           ...
                           Toast.makeText(getApplicationContext(), "Rating field is required", Toast.LENGTH_LONG).show();
                       } else {
                ...
                if (result != null) {
                    ...
                    try {
                     ...
                     //   makeText(StudentCourseDetail.this, dataArray.getString("updated_date"), Toast.LENGTH_SHORT).show();
                        ...
                        courseclass.setText(dataArray.getString("class")+"-"+dataArray.getString("section"));
